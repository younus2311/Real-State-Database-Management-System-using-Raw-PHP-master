...
<tr>
<form name="form1" method="post" action="projectcreationDATA.php">
<td>
<table width="100%" border="0" cellpading="3" cellspacing="1">
<tr>
<td colspan="3"><strong>PROJECT CREATION</strong></td>
</tr>
<tr>
<td width="78">Project Name</td>
<td width="6">:</td>
<td width="294"><input name="projectName" type="text" id="projectName"></td>
</tr>
<tr>
...
<tr>
<td width="78">Estimated time</td>
<td width="6">:</td>
<td width="294"><input name="estimatedTime" type="text" ></td>
